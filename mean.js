...
//    db = mongojs("js_june", ['khan','jobPosts']);

var mongoose = require('mongoose');

var expressSession = require('express-session');
app.use(expressSession({secret:'Althaf', saveUninitialized: false, resave: false}));
...
app.post('/postData', function(req, res) {
    ...
    mongo_conn.collection('khan').insert(doc, function(err, response) {
        if(response) {
